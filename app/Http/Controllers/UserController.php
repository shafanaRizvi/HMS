...
class UserController extends AppBaseController
{
     ...
     * @throws Throwable
     */
    public function store_old(CreateUserRequest $request): RedirectResponse
    {
        try {
            DB::beginTransaction();
            $input = $request->all();
    ...
    public function store(CreateUserRequest $request): RedirectResponse
    {
        ...
        try {
            ...
            // We can skip this check as it's handled in the repository
            // $existingUser = User::where('email', $input['email'])->first();
    
            // if ($existingUser) {
            //     DB::rollBack();
            //     Flash::error(__('messages.flash.user_exists')); // or any appropriate message
