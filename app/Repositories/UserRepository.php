...
class UserRepository extends BaseRepository
{
    ...
    public function store_old($input): bool
    {
        try {
    ...
    public function store($input): bool
    {
        ...
        try {
            ...
            if ($existingUser) {
                throw new UnprocessableEntityHttpException(__('messages.flash.user_exists'));
            }
            ...
            // Handle subscriptions and specific department logic
            if ($input['department_id'] == 1) {
                $subscriptionPlan = SubscriptionPlan::where('is_default', 1)->first();
                $trialDays = $subscriptionPlan->trial_days;
                $subscription = [
