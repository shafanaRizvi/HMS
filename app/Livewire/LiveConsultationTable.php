...
class LiveConsultationTable extends LivewireTableComponent
{
    ...
    public function builder(): Builder
    {
        ...
        $query = LiveConsultation::where('live_consultations.tenant_id', '=',getLoggedInUser()->tenant_id)->whereHas('patient.patientUser')->whereHas('doctor.doctorUser')->whereHas('user')->with([
