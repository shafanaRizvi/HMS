...
class PatientDiagnosisTestTable extends LivewireTableComponent
{
    ...
    {
        $query = PatientDiagnosisTest::where('patient_diagnosis_tests.tenant_id', '=', getLoggedInUser()->tenant_id)->whereHas('patient.patientUser')->whereHas('doctor.doctorUser')->with('patient.patientUser',
            'doctor.doctorUser',
