...
class PatientAdmissionTable extends LivewireTableComponent
{
    ...
    {
        $query = PatientAdmission::where('patient_admissions.tenant_id', '=',getLoggedInUser()->tenant_id)->whereHas('patient.patientUser')->whereHas('doctor.doctorUser')->with('patient.patientUser',
