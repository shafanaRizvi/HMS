...
class AdvancedPaymentTable extends LivewireTableComponent
{
    ...
    public function builder(): Builder
    {
        ...
        $query = AdvancedPayment::where('advanced_payments.tenant_id', '=', getLoggedInUser()->tenant_id)->whereHas('patient.patientUser')->with('patient.patientUser')->select('advanced_payments.*');
