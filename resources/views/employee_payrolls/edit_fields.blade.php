<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-3 col-md-4 col-sm-12 mb-5">
        ...
        {{ Form::text('basic_salary', null, ['id' => 'editEmployeePayrollBasicSalary','class' => 'form-control decimal-number EmployeePayrollBasicSalary', 'maxlength' => '7','required', 'placeholder' => __('messages.employee_payroll.basic_salary')]) }}
    </div>
    <div class="col-lg-3 col-md-4 col-sm-12 mb-5">
        {{ Form::label('allowance', __('messages.employee_payroll.allowance').(':'), ['class' => 'form-label required mb-3']) }}
        {{ Form::text('allowance', null, ['id' => 'editEmployeePayrollAllowance','class' => 'form-control price-input EmployeePayrollAllowance','onkeyup' => 'if (/\D\./g.test(this.value)) this.value = this.value.replace(/\D\./g,"")', 'maxlength' => '5','required', 'placeholder' => __('messages.employee_payroll.allowance')]) }}
    </div>
    <div class="col-lg-3 col-md-4 col-sm-12 mb-5">
        {{ Form::label('deductions', __('messages.employee_payroll.deductions').(':'), ['class' => 'form-label required mb-3']) }}
        {{ Form::text('deductions', null, ['id' => 'editEmployeePayrollDeductions','class' => 'form-control price-input EmployeePayrollDeductions','onkeyup' => 'if (/\D\./g.test(this.value)) this.value = this.value.replace(/\D\./g,"")', 'maxlength' => '5','required', 'placeholder' => __('messages.employee_payroll.deductions')]) }}
    </div>
    <div class="col-lg-3 col-md-4 col-sm-12 mb-5">
        {{ Form::label('net_salary', __('messages.employee_payroll.net_salary').(':'),['class' => 'form-label required mb-3']) }}
        {{ Form::text('net_salary', null, ['id' => 'editEmployeePayrollNetSalary','class' => 'form-control price-input employeePayrollNetSalary','onkeyup' => 'if (/\D\./g.test(this.value)) this.value = this.value.replace(/\D\./g,"")', 'maxlength' => '7','required','readonly', 'placeholder' => __('messages.employee_payroll.net_salary')]) }}
    </div>
</div>
