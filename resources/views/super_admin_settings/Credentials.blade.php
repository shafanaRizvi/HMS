                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 d-flex align-items-center">
                            ...
                            <label class="form-check form-switch form-switch-sm ms-3">
                                <input type="checkbox" name="razorpay_enable" class="form-check-input razorpay_enable"
                                    value="1" {{ !empty($setting['razorpay_enable']) == '1' ? 'checked' : '' }} id="razorpayEnableAdmin">
                                <span class="custom-switch-indicator"></span>
                            </label>
                        </div>
                        ...
                        <div class="paystack-div-admin col-12">
                            <div class="row">
                                <div class="form-group col-sm-6 mb-5">
                                    {{ Form::label('paystack_key', __('messages.setting.paystack_public_key') . ':', ['class' => 'form-label']) }}
                                ...
                                <div class="form-group col-sm-6 mb-5">
                                    {{ Form::label('paystack_secret', __('messages.setting.paystack_secret_key') . ':', ['class' => 'form-label']) }}
                        ...
                        <div class="phonepe-div-admin col-12">
                            <div class="row">
                                <div class="form-group col-sm-6 mb-5">
                                    {{ Form::label('phonepe_merchant_id', __('messages.phonepe.phonepe_merchant_id') . ':', ['class' => 'form-label']) }}
                                ...
                                <div class="form-group col-sm-6 mb-5">
                                    {{ Form::label('phonepe_merchant_user_id', __('messages.phonepe.phonepe_merchant_user_id') . ':', ['class' => 'form-label']) }}
                                ...
                                <div class="form-group col-sm-6 mb-5">
                                    {{ Form::label('phonepe_env', __('messages.phonepe.phonepe_env') . ':', ['class' => 'form-label']) }}
                                ...
                                <div class="form-group col-sm-6 mb-5">
                                    {{ Form::label('phonepe_salt_key', __('messages.phonepe.phonepe_salt_key') . ':', ['class' => 'form-label']) }}
                                ...
                                <div class="form-group col-sm-6 mb-5">
                                    {{ Form::label('phonepe_salt_index', __('messages.phonepe.phonepe_salt_index') . ':', ['class' => 'form-label']) }}
                                ...
                                <div class="form-group col-sm-6 mb-5">
                                    {{ Form::label('phonepe_merchant_transaction_id', __('messages.phonepe.phonepe_merchant_transaction_id') . ':', ['class' => 'form-label']) }}
                        ...
                        <div class="flutterwave-div-admin col-12">
                            <div class="row">
                                <div class="form-group col-sm-6 mb-5">
                                    {{ Form::label('flutterwave_key', __('messages.flutterwave.flutterwave_public_key') . ':', ['class' => 'form-label']) }}
                                ...
                                <div class="form-group col-sm-6 mb-5">
                                    {{ Form::label('flutterwave_secret', __('messages.flutterwave.flutterwave_secret_key') . ':', ['class' => 'form-label']) }}
