<div class="row">
    ...
    <div class="col-md-4 col-sm-12">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::text('purchase_price', null, ['id'=>'purchasePrice','class' => 'form-control price-input','required', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'maxlength' => '6','minlength' => '1', 'placeholder' => __('messages.item_stock.purchase_price')]) }}
        </div>
    </div>
