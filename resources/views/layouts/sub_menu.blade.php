...
@module('Schedules', $modules)
    ...
    @if ($schedule)
        <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('schedules*') ? 'd-none' : '' }}">
            <a class="nav-link p-0 {{ Request::is('schedules*') ? 'active' : '' }}"
                href="{{ route('schedules.edit', $schedule->id) }}">{{ __('messages.schedules') }}</a>
        </li>
    @else
        <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('schedules*') ? 'd-none' : '' }}">
            <a class="nav-link p-0 {{ Request::is('schedules*') ? 'active' : '' }}"
                href="{{ route('schedules.create') }}">{{ __('messages.schedules') }}</a>
        </li>
    @endif
@endmodule
...
@role('Doctor|Accountant|Case Manager|Receptionist|Pharmacist|Lab Technician|Nurse')
    @module('My Payrolls', $modules)
        <li
            class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('employee/payroll*') ? 'd-none' : '' }}">
...
@role('Patient')
    @module('Patient Cases', $modules)
        <li
            class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('patient/my-cases*') ? 'd-none' : '' }}">
...
@role('Patient')
    @module('Invoices', $modules)
        <li
            class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('employee/invoices*') ? 'd-none' : '' }}">
