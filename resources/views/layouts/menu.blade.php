...
@module('Schedules', $modules)
    ...
    <li class="nav-item {{ Request::is('schedules*') ? 'active' : '' }}">
        @if ($schedule)
            <a class="nav-link d-flex align-items-center py-3" href="{{ route('schedules.edit', $schedule->id) }}">
                <span class="aside-menu-icon pe-3"><i class="fa fa-calendar"></i></span>
                <span class="aside-menu-title">{{ __('messages.schedules') }}</span>
            </a>
        @else
            <a class="nav-link d-flex align-items-center py-3" href="{{ route('schedules.create') }}">
                <span class="aside-menu-icon pe-3"><i class="fa fa-calendar"></i></span>
                <span class="aside-menu-title">{{ __('messages.schedules') }}</span>
            </a>
        @endif
...
@role('Super Admin')
    ...
    {{-- Super Admin Users --}}
    <li
        class="nav-item {{ Route::is('super.admin.hospitals.index', 'hospital.create', 'hospital.edit') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 " aria-current="page"
