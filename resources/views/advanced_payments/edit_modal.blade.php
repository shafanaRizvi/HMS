            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('amount', null, ['class' => 'form-control decimal-number ','id'=> 'editAdvancedPaymentAmount','required', 'maxlength' => '7', 'placeholder' => __('messages.advanced_payment.amount')]) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
