            ...
            @foreach($data['availableOn'] as $days)
                <tr>
                    <td class="schedules-table-td">
                        {{ Form::text('available_on[]', isset($scheduleDays)?__('messages.schedule_weekday.'.$scheduleDays[$loop->iteration-1]->available_on):__('messages.schedule_weekday.'.$days),
...
<div class="d-flex justify-content-end">
    {!! Form::submit(__('messages.common.save'), ['class' => 'btn btn-primary me-2','id' => 'scheduleSave',$data['hospitalSchedule'] == null ? 'disabled':''
    ]) !!}
