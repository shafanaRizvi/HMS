                                    ...
                                    <div
                                        ...
                                        <div class="text-end">
                                            <h2 class="fs-1-xxl fw-bolder text-primary">
                                                {{ $data['TotalAppointments'] }}</h2>
                                            <h3 class="mb-0 fs-5 fw-bold text-dark">{{ __('messages.patient.total_appointments') }}
                                            </h3>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-sm-6 widget">
                                <a href="{{ route('appointments.index') }}" class="text-decoration-none">
                                    <div
                                        ...
                                        <div class="text-end">
                                            <h2 class="fs-1-xxl fw-bolder text-primary">
                                                {{ $data['TodayAppointments'] }}</h2>
                                            <h3 class="mb-0 fs-5 fw-bold text-dark">{{ __('messages.lunch_break.todays_appointments') }}</h3>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-sm-6 widget">
                                <a href="{{ route('live.consultation.index') }}" class="text-decoration-none">
                                    <div
                                        ...
                                        <div class="text-end">
                                            <h2 class="fs-1-xxl fw-bolder text-primary">
                                                {{ $data['TotalMeetings'] }}</h2>
                                            <h3 class="mb-0 fs-5 fw-bold text-dark">{{ __('messages.lunch_break.total_meetings') }}
                                            </h3>
                                        </div>
                                    </div>
                                </a>
                                    ...
                                    <div
                                        ...
                                        <div class="text-end">
                                            <h2 class="fs-1-xxl fw-bolder text-primary">{{ $currencySymbol }}
                                                {{ formatCurrency($data['patientBill']) }}</h2>
