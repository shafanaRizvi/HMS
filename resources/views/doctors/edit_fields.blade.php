...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::number('appointment_charge', isset($doctor) ? $doctor->appointment_charge : '', ['class' => 'form-control','placeholder'=>__('messages.appointment_charge'),'onkeyup' =>'if (/[e\+\-]/g.test(this.value)) this.value = this.value.replace(/[e\+\-]/g,"")']) }}
        </div>
    </div>
