...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::text('dob', null, ['class' => (getLoggedInUser()->thememode ? 'bg-light form-control' : 'bg-white form-control'),'id' => 'doctorBirthDate','autocomplete' => 'off', 'placeholder' => __('messages.user.dob')]) }}        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::number('appointment_charge', null, ['class' => 'form-control charge-appointment','placeholder'=>__('messages.appointment_charge'),'onkeyup' =>'if (/[e\+\-]/g.test(this.value)) this.value = this.value.replace(/[e\+\-]/g,"")']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
