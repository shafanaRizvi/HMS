    ...
    <div class="row">
        ...
        @else
            <div class="col-lg-3 col-md-4 col-sm-12 mb-5">
                {{ Form::label('bill_date', __('messages.bill.bill_date') . ':', ['class' => 'form-label']) }}
                <span class="required"></span>
                {{ Form::text('bill_date', null, ['class' => getLoggedInUser()->thememode ? 'bg-light form-control medicine_bill_date' : 'bg-white form-control medicine_bill_date', 'id' => 'medicine_bill_date', 'autocomplete' => 'off', 'placeholder' => __('messages.bill.bill_date')]) }}
            </div>
        @endif
