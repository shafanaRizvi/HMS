                            ...
                            <tbody>
                                @foreach ($bill['payments'] as $payment)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <b>{{ getCurrencySymbol() }}</b>{{ number_format($payment->amount) }}
                                            </p>
                                        </td>
                                    </tr>
                                @endforeach
                    ...
                    <td colspan="2">
                        <table class="table number-align w-100 bg-light table-footer">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-start" colspan="4">{{ __('messages.ipd_bill.total_charges') . ':' }}</td>
                                ...
                                <tr>
                                    ...
                                    <td class="font-weight-bold">
                                        <b>{{ getCurrencySymbol() }}{{ $grossTotal }}</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-start" colspan="4">{{ __('messages.ipd_bill.discount_in_percentage') . ':' }}
                                    </td>
                                ...
                                <tr>
                                    <td class="text-start" colspan="4">{{ __('messages.ipd_bill.tax_in_percentage') . ':' }}</td>
                                    <td class="text-right font-weight-bold">{{ $bill['tax_in_percentage'] . '%' }}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-start" colspan="4">{{ __('messages.ipd_bill.other_charges') . ':' }}</td>
                                    <td class="font-weight-bold">
                                        <b>{{ getCurrencySymbol() }}{{ $bill['other_charges'] }}</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-start" colspan="4">{{ __('messages.ipd_bill.paid_amount') . ':' }}</td>
                                    <td class="font-weight-bold text-end">
                                        <b>{{ getCurrencySymbol() }}{{ $bill['total_payment'] }}</b>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="font-weight-bold">
                                        <b>{{ getCurrencySymbol() }}{{ number_format($bill['patient_net_payable_amount']) }}</b>
                                    </td>
                                </tr>
