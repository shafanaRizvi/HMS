...
listenSubmit('#UserCredentialsSettings', function (e) {
    ...
    if (PhonePeCheckbox && $('.phonepe_merchant_id').val().trim() == '') {
        displayErrorMessage(Lang.get('Phonepe Merchant Id field is required'))
        return false
    }
    if (PhonePeCheckbox && $('.phonepe_merchant_user_id').val().trim() == '') {
        displayErrorMessage(Lang.get('Phonepe Merchant User Id field is required'))
        return false
    }
    ...
    if (PhonePeCheckbox && $('.phonepe_salt_key').val().trim() == '') {
        displayErrorMessage(Lang.get('Phonepe Salt Key field is required'))
        return false
    }
    if (PhonePeCheckbox && $('.phonepe_salt_index').val().trim() == '') {
        displayErrorMessage(Lang.get('Phonepe Salt Index field is required'))
        return false
    }
    if (PhonePeCheckbox && $('.phonepe_merchant_transaction_id').val().trim() == '') {
        displayErrorMessage(Lang.get('Phonepe Merchant Transaction Id field is required'))
        return false
    }

    if (flutterWaveCheckbox && $('.flutterwave_public_key').val().trim() == '') {
        displayErrorMessage(Lang.get('FlutterWave Public Key field is required'))
        return false
    }

    if (flutterWaveCheckbox && $('.flutterwave_secret_key').val().trim() == '') {
        displayErrorMessage(Lang.get('FlutterWave secret Key field is required'))
        return false
    }
